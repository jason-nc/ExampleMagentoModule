...
/*
 * Modify Search to find matches with all search terms
 * Modify method prepareResult($object, $queryText, $query)
 * 	Change $likeCond = '(' . join(' OR ', $like) . ')';
 *	To     $likeCond = '(' . join(' AND ', $like) . ')';
 *
