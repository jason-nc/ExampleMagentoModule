 ...
 */
    ...
    public function isDisabled()
    {
    	...
    	public function getItemAltitudeByQuoteId($quoteId) {
	        Mage::log('in getItemAltitudeByQuoteId',null,'tsmCatalogModelProduct.log');
	 	$itemId = $this->getId();
	 	...
	 	$query = 'SELECT * FROM sales_flat_quote_item WHERE quote_id = ' . $quoteId . ' AND quote_item_id = ' . $itemId;
	        Mage::log('query: ' . $query,null,'tsmCatalogModelProduct.log');
	...
	/*      $query = "SELECT q.* FROM `sales_order_entity_int` o
	        ...
	        Mage::log('done getItemAltitudeByQuoteId',null,'tsmCatalogModelProduct.log');
	    }    
}
