...
class Mage_Adminhtml_Block_Sales_Order_View_Items extends Mage_Adminhtml_Block_Sales_Items_Abstract
{
	...
	*/
	...
	public function getItemAltitude($item) {
	        
		Mage::log('in getItemAltidude call',null,'tsmAdminhtmlBlockSalesOrderViewItem.log');
		...
		Mage::log('done getItemAltidude call',null,'tsmAdminhtmlBlockSalesOrderViewItem.log');
