 ...
 */
class TSM_OSRCustomShipping_Model_Osrcustomups
    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    {
	Mage::log('In collect rates',null,'tsmOSRUPSLogFile.log');
	
        if (!$this->getConfigFlag('active')) {
		Mage::log('Is not active',null,'tsmOSRUPSLogFile.log');
            	return false;
        }
	Mage::log('Is active',null,'tsmOSRUPSLogFile.log');
	...
	if($this->getConfigData('max_amount_charged') < $request->getPackageValue()){
		Mage::log('Cart Total Amount is more than Maximum amount for free shipping. Cart total: ' . $request->getPackageValue(),null,'tsmOSRFreeLogFile.log');
		return false;
	}
	...
	Mage::log('Done with collect rates',null,'tsmOSRUPSLogFile.log');
